 ...
 * 
 * */
public class DisplayObjectOld extends EventDispatcher {
	...
	public boolean hasMultiHitboxes = false;
	/*
	...
	*/
	private void setDefaultHitbox()
	{
		Rectangle hitbox = new Rectangle();
		if(this.getScaleX() > 0) 
			hitbox.x = (int) this.getPosition().getX();
		else
			hitbox.x = (int)(this.getPosition().getX()-this.getDisplayImage().getWidth()*Math.abs(this.getScaleX()));

		if(this.getScaleY() > 0)
			hitbox.y = (int) this.getPosition().getY();
		else
			hitbox.y = (int)(this.getPosition().getY()+this.getDisplayImage().getHeight()*Math.abs(this.getScaleY()));
	 ...
	 */
	public DisplayObjectOld(String id) {
		this.setPosition(new Point(0,0));
		this.setId(id);
		setDefaults();
	}

	public DisplayObjectOld(String id, String fileName) {
		this.setPosition(new Point(0,0));
//		this.setDefaultHitbox();
		this.setId(id);
